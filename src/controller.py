...
class Controller:
    def __init__(self, width=640, height=480):
      ...
      args: self, width (int), height(int)'''
        ...
        self.firstAid = firstAid.FirstAid("assets/firstAid.png")
        self.all_sprites = pygame.sprite.Group((self.hero,) + tuple(self.enemies) + (self.firstAid,))
        self.state = "GAME"
    ...
    def gameLoop(self):
        while self.state == "GAME":
            ...
            healed = self.hero.rect.colliderect(self.firstAid.rect)
            if healed :
                self.hero.heal()
                self.background.fill((250,250,250))
                ...
                for i in range(num_enemies):
                  ...
                  self.firstAid.rect.x = self.hero.rect.x + self.hero.width + 5
                  self.firstAid.rect.y = self.hero.rect.y + self.hero.height + 5
                  self.enemies.add(e)
